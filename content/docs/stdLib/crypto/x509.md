...
#### func CreateCertificate [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CreateCertificate)
...
#### func CreateCertificateRequest [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CreateCertificateRequest)added in go1.3
...
#### func CreateRevocationList [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CreateRevocationList)added in go1.15
...
#### func MarshalECPrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#MarshalECPrivateKey)added in go1.2
...
#### func MarshalPKCS1PrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#MarshalPKCS1PrivateKey)
...
#### func MarshalPKCS1PublicKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#MarshalPKCS1PublicKey)added in go1.10
...
#### func MarshalPKCS8PrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#MarshalPKCS8PrivateKey)added in go1.10
...
#### func MarshalPKIXPublicKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#MarshalPKIXPublicKey)
...
#### func ParseECPrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParseECPrivateKey)added in go1.1
...
#### func ParsePKCS1PrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParsePKCS1PrivateKey)
...
#### func ParsePKCS1PublicKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParsePKCS1PublicKey)added in go1.10
...
#### func ParsePKCS8PrivateKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParsePKCS8PrivateKey)
...
#### func ParsePKIXPublicKey [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParsePKIXPublicKey)
...
#### func SetFallbackRoots [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SetFallbackRoots)added in go1.20
...
### type CertPool [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertPool)
...
#### func NewCertPool [¶](https://pkg.go.dev/crypto/x509@go1.20.1#NewCertPool)
...
#### func SystemCertPool [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SystemCertPool)added in go1.7
...
#### (*CertPool) AddCert [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertPool.AddCert)
...
#### (*CertPool) AppendCertsFromPEM [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertPool.AppendCertsFromPEM)
...
#### (*CertPool) Clone [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertPool.Clone)added in go1.19
...
#### (*CertPool) Equal [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertPool.Equal)added in go1.19
...
### type Certificate [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate)
...
#### func ParseCertificate [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParseCertificate)
...
#### func ParseCertificates [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParseCertificates)
...
#### (*Certificate) CheckSignature [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate.CheckSignature)
...
#### (*Certificate) CheckSignatureFrom [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate.CheckSignatureFrom)
...
#### (*Certificate) Equal [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate.Equal)

```
func (c *Certificate) Equal(other *Certificate) bool
```

#### (*Certificate) Verify [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate.Verify)
...
#### (*Certificate) VerifyHostname [¶](https://pkg.go.dev/crypto/x509@go1.20.1#Certificate.VerifyHostname)
...
### type CertificateInvalidError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertificateInvalidError)
...
#### (CertificateInvalidError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertificateInvalidError.Error)

```
func (e CertificateInvalidError) Error() string
```

### type CertificateRequest [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertificateRequest)added in go1.3
...
#### func ParseCertificateRequest [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParseCertificateRequest)added in go1.3
...
#### (*CertificateRequest) CheckSignature [¶](https://pkg.go.dev/crypto/x509@go1.20.1#CertificateRequest.CheckSignature)added in go1.5
...
### type ConstraintViolationError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ConstraintViolationError)
...
#### (ConstraintViolationError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ConstraintViolationError.Error)

```
func (ConstraintViolationError) Error() string
```

### type ExtKeyUsage [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ExtKeyUsage)
...
### type HostnameError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#HostnameError)
...
#### (HostnameError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#HostnameError.Error)

```
func (h HostnameError) Error() string
```

### type InsecureAlgorithmError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#InsecureAlgorithmError)added in go1.6
...
#### (InsecureAlgorithmError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#InsecureAlgorithmError.Error)added in go1.6

```
func (e InsecureAlgorithmError) Error() string
```

### type InvalidReason [¶](https://pkg.go.dev/crypto/x509@go1.20.1#InvalidReason)
...
### type KeyUsage [¶](https://pkg.go.dev/crypto/x509@go1.20.1#KeyUsage)
...
### type PEMCipher [¶](https://pkg.go.dev/crypto/x509@go1.20.1#PEMCipher)added in go1.1
...
### type PublicKeyAlgorithm [¶](https://pkg.go.dev/crypto/x509@go1.20.1#PublicKeyAlgorithm)
...
#### (PublicKeyAlgorithm) String [¶](https://pkg.go.dev/crypto/x509@go1.20.1#PublicKeyAlgorithm.String)added in go1.10

```
func (algo PublicKeyAlgorithm) String() string
```

### type RevocationList [¶](https://pkg.go.dev/crypto/x509@go1.20.1#RevocationList)added in go1.15
...
#### func ParseRevocationList [¶](https://pkg.go.dev/crypto/x509@go1.20.1#ParseRevocationList)added in go1.19
...
#### (*RevocationList) CheckSignatureFrom [¶](https://pkg.go.dev/crypto/x509@go1.20.1#RevocationList.CheckSignatureFrom)added in go1.19
...
### type SignatureAlgorithm [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SignatureAlgorithm)
...
#### (SignatureAlgorithm) String [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SignatureAlgorithm.String)added in go1.6

```
func (algo SignatureAlgorithm) String() string
```

### type SystemRootsError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SystemRootsError)added in go1.1
...
#### (SystemRootsError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SystemRootsError.Error)added in go1.1

```
func (se SystemRootsError) Error() string
```

#### (SystemRootsError) Unwrap [¶](https://pkg.go.dev/crypto/x509@go1.20.1#SystemRootsError.Unwrap)added in go1.16

```
func (se SystemRootsError) Unwrap() error
```

### type UnhandledCriticalExtension [¶](https://pkg.go.dev/crypto/x509@go1.20.1#UnhandledCriticalExtension)

```
type UnhandledCriticalExtension struct{}
```

#### (UnhandledCriticalExtension) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#UnhandledCriticalExtension.Error)

```
func (h UnhandledCriticalExtension) Error() string
```

### type UnknownAuthorityError [¶](https://pkg.go.dev/crypto/x509@go1.20.1#UnknownAuthorityError)
...
#### (UnknownAuthorityError) Error [¶](https://pkg.go.dev/crypto/x509@go1.20.1#UnknownAuthorityError.Error)

```
func (e UnknownAuthorityError) Error() string
```

### type VerifyOptions [¶](https://pkg.go.dev/crypto/x509@go1.20.1#VerifyOptions)
