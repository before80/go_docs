...
### type Cipher [¶](https://pkg.go.dev/crypto/rc4@go1.20.1#Cipher)
...
#### func NewCipher [¶](https://pkg.go.dev/crypto/rc4@go1.20.1#NewCipher)
...
#### (*Cipher) XORKeyStream [¶](https://pkg.go.dev/crypto/rc4@go1.20.1#Cipher.XORKeyStream)
...
### type KeySizeError [¶](https://pkg.go.dev/crypto/rc4@go1.20.1#KeySizeError)

```
type KeySizeError int
```

#### (KeySizeError) Error [¶](https://pkg.go.dev/crypto/rc4@go1.20.1#KeySizeError.Error)
