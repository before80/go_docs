...
#### func GenerateKey [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#GenerateKey)
...
#### func Sign [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#Sign)
...
#### func Verify [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#Verify)
...
#### func VerifyWithOptions [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#VerifyWithOptions)added in go1.20
...
### type Options [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#Options)added in go1.20
...
#### (*Options) HashFunc [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#Options.HashFunc)added in go1.20
...
### type PrivateKey [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PrivateKey)
...
#### func NewKeyFromSeed [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#NewKeyFromSeed)
...
#### (PrivateKey) Equal [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PrivateKey.Equal)added in go1.15
...
#### (PrivateKey) Public [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PrivateKey.Public)
...
#### (PrivateKey) Seed [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PrivateKey.Seed)
...
#### (PrivateKey) Sign [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PrivateKey.Sign)
...
### type PublicKey [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PublicKey)
...
#### (PublicKey) Equal [¶](https://pkg.go.dev/crypto/ed25519@go1.20.1#PublicKey.Equal)added in go1.15
