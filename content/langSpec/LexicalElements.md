...
>
> ​	具体来说，Unicode中的"surrogate halves"或"surrogates"是指位于U+D800到U+DFFF之间的代码点。这些代码点不是用来直接表示字符的，而是被用作表示那些位于U+10000到U+10FFFF之间的字符的"代理"。
>
...
>
> ​	在UTF-16编码中，U+D800到U+DFFF之间的代码点被用作"高代理"（high surrogates）和"低代理"（low surrogates）。一个高代理和一个低代理结合在一起，形成一个"代理对"（surrogate pair），可以表示一个位于U+10000到U+10FFFF之间的字符。
>
